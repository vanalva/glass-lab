/* ════════════════════════════════════════════════════════════════════
   pg-sistemas-animations.js — GSAP animations for Pernia Glass Sistemas page
...
(function () {
  ...
  function runAnimations() {
    ...
    /* ── PRE-HIDE sistema cards + footer ──────────────────────────── */
    gsap.set('.pg-sistemas_card', { autoAlpha: 0 });
    gsap.set('.pg-footer_col', { autoAlpha: 0, y: 20 });

    /* ── BATCH REVEAL — sistema cards (gl-proyectos values) ───────── */
